...
public class Board{
    ...
    Board() {
        ...
        /*for(int i = 1; i < 9; i++){
            Arrow arrow = new Arrow(i,1,board[i][1]);
            board[i][1].setArrow(arrow);
            addArrowsGroup(arrow);
        }*/
    }
    ...
    public void addCirclesGroup(LegalMove circle) {
    ...
    private void currentGameState() {
        ...
        if(iloscMozliwychRuchow == 0) {
            AmazonApp.displayStatusText("Wygral biały !");
            currentTurn=null;
            return;
        }
        ...
        if(iloscMozliwychRuchow == 0) {
            AmazonApp.displayStatusText("Wygral czarny !");
            currentTurn=null;
            return;
        }
    }
