...
public class AmazonApp extends Application {
    ...
    private Parent createContent() {
        ...
        Pane table = new Pane();
        board = new Board();
        table.setPrefSize(10*100,10*100);
        table.getChildren().addAll(board.getTileGroup(),board.getArrowsGroup(),board.getQueensGroup(),board.getCirclesGroup());
